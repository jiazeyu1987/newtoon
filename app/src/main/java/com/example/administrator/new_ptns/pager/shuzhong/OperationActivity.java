...
public class OperationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init_false_data();
        channel3.btn1.performClick();
        channel4.btn1.performClick();
    }
    ...
    private void do_save_para() {
        ...
        if (electrodeBundle.id == 1) {
            G.g_patient_data.latest_patientOperationData.electrodeBundle1 = electrodeBundle;
        } else {
            G.g_patient_data.latest_patientOperationData.electrodeBundle2 = electrodeBundle;
        }
