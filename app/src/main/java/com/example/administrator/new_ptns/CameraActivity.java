...
//                .filePath()
                .onResult(new Action<String>() {
                    ...
                    public void onAction(@NonNull String result) {
                        ...
                        G.g_patient_data.latest_patientOperationData.operation_picture_path.add(result);
                        editor.putString("pic",result);
                        editor.commit();
...
//                .filePath()
                ...
                .onResult(new Action<String>() {
                    ...
                    public void onAction(@NonNull String result) {
                        ...
                        playVideo(result);
                        editor.putString("camera",result);
                        editor.commit();
                        G.g_patient_data.latest_patientOperationData.operation_camera_path.add(result);
                        CameraActivity.this.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.parse("file://" + result)));
                        Album.getAlbumConfig()
                                .getAlbumLoader()
                                .load(mImageView, result);
