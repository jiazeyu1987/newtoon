...
public class OperationTempData extends AABaseData{
    public int id;
    public int lor_position = 1;
    public int electrode_id = 1;
    ...
    public OperationTempData(int id1,int electrode_id1,String long_date1,String electrode_position1,String electrode_data1,String impedance1,String stim_para1){
        id = id1;
        electrode_id = electrode_id1;
