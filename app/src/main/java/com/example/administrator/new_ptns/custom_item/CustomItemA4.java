...
public class CustomItemA4 extends LinearLayout {
    ...
    public CustomItemA4(Context context) {
        this(context, null);
    }

    public CustomItemA4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomItemA4(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        mView = inflater.inflate(R.layout.custom_item_a4, this, true);
