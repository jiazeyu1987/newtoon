...
public class PagerShuzhong extends PagerBase {
    ...
    public void init_view(View view,String type){
        ...
        ci_electrode2.btn1.setText("R");
        ci_electrode2.btn2.setText("规格二");
    }
    ...
    private void do_enter1(){
        ...
        G.g_patient_data.latest_patientOperationData.position1 = bundle;
        G.g_patient_data.latest_patientOperationData.electrodeBundle1 = bundle;
        Gson gson = new Gson();
    ...
    private void do_enter2(){
        ...
        bundle.guige = para2;
        bundle.xuliehao = para3;
        G.g_patient_data.latest_patientOperationData.position2 = bundle;
        G.g_patient_data.latest_patientOperationData.electrodeBundle2 = bundle;
        Gson gson = new Gson();
        String s1 = gson.toJson(bundle);
        intent.putExtra("extra",s1);
        mContext.startActivity(intent);
    ...
    private void set_global_contact(ContactData contactData){
        ...
        G.g_patient_data.latest_patientOperationData.contact_number = contactData.contact_number;
    }
