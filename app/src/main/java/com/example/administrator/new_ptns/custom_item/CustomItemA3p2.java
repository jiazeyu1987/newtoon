...
public class CustomItemA3p2 extends LinearLayout {
    ...
    public CustomItemA3p2(Context context) {
        this(context, null);
    }

    public CustomItemA3p2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomItemA3p2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        mView = inflater.inflate(R.layout.custom_item_a3p2, this, true);
