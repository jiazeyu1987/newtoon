...
public class CustomItem5 extends LinearLayout {
    ...
    public CustomItem5(Context context) {
        this(context, null);
    }

    public CustomItem5(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomItem5(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mView = inflater.inflate(R.layout.custom_item_5, this, true);
        txt = (TextView) mView.findViewById(R.id.textView27);
        icon =  mView.findViewById(R.id.imageView2);
        ...
        setIconImgId(a.getResourceId(R.styleable.CustomItem1Attr_icon1, 10000));
    }
